...
import { getAdminStudiosGrowth, getAdminUserApprovals, getAppContext } from "@/lib/supabase/queries";
...
export default async function ConfiguracoesPage() {
  ...
  const userApprovalData = context.userRole === "platform_admin"
    ...
    : { users: [], studios: [] };
  const adminStudiosGrowth = context.userRole === "platform_admin"
    ? await getAdminStudiosGrowth()
    : [];
  ...
  return (
    <StudioPageShell title="Configuracoes" eyebrow={context.studioName}>
      ...
      <SettingsTabs
        ...
        adminStudiosGrowth={adminStudiosGrowth}
